...
class StructureLayer(models.Model):
    ...
    standard_structure_layer = models.ForeignKey(StandardStructureLayer, verbose_name="наименование слоя материала",
    ...
    def my_property(self):
        return f"{self.name} is {self.thickness_layer} thickness."
