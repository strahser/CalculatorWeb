...
class EnergyClasses:
    ...
    def add_energy_class_by_building_volume(self) -> pd.DataFrame:
        ...
        interpolate_df_data["Расход газа, м3"] = interpolate_df_data[
                                                     BaseNames.total_energy.value] * Constant.kwt_to_m_3.value
        interpolate_df_data["Стоимость газа,руб"] = interpolate_df_data[
                                                        BaseNames.total_energy.value] * Constant.gas_coast.value
    ...
    def gas_metrics(self, df_values: pd.DataFrame, energy_class1, energy_class2):
        ...
        delta_consumption_gas = __sub_query(energy_class2, "Расход газа, м3") - __sub_query(energy_class1,
                                                                                            "Расход газа, м3")
